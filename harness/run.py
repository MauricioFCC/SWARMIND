...
Helpers de CLI extraidos a run_support.py (regla AGR: archivos < 500 lineas).
"""
...
# Helpers extraidos a run_support.py (regla AGR: archivos < 500 lineas).
# Se re-importan aqui para mantener backward-compat con
# ``from harness.run import _parse_args`` y los patches de los tests.
from harness.run_support import (
    _USAGE_LINES,
    _dispatch_task,
