"""Perfiles de expertos disponibles para el debate (registry).

Submodulo del paquete :mod:`harness.orchestrator.worktable`.

Contiene el diccionario ``AGENT_PROFILES`` con los 13 expertos clasicos
de calidad de software, extraido de forma mecanica desde ``worktable.py``
