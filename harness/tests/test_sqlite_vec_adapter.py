...
class TestSQLiteVecAdapterInsert:
    ...
    def test_add_vector_wrong_collection_raises(self):
        ...
        with make_adapter() as a, pytest.raises(CollectionNotFoundError):
