...
class TestTaskOrchestrator:
    ...
    async def test_target_agent_builder(self):
        ...
        await self.orch.process_message("implementar API en Rust")
    ...
    async def test_target_agent_scientist(self):
        ...
        await self.orch.process_message("investigar patrones")

    @pytest.mark.slow
    @pytest.mark.asyncio
    async def test_target_agent_guardian(self):
        """Security task → target agent is guardian."""
        await self.orch.process_message("auditar seguridad")
