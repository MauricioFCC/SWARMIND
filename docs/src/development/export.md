# Exportacion, Backup y Deploy — AGENTIC

> **Destino:** `C:\Users\USUARIO\Mi unidad\DEV\SIDEPROYECT\exports\`  
> **Scripts:** Todos en `scripts/`

---

## 1. Exportar AGENTIC a Google Drive
...
Exporta AGENTIC, CQE, HC, Onyx, PDV y Alfa con ZIPs fechados.  
...
Sincroniza `.opencode/` y `harness/` a: core-quant-engine, Historia Clinica, Onyx, PDV Basic, Hermes_Memory_Proyects, de_0_a_Alfa.  
...
python scripts/agentic_bridge_sync.py             # Sync memoria entre proyectos
python scripts/agentic_bridge_sync.py --status    # Ver estado del bridge
```

## 6. Estructura de Exports

```
C:\Users\USUARIO\Mi unidad\DEV\SIDEPROYECT\exports\
├── AGENTIC_2026-07-24.zip
├── CQE_2026-07-24.zip
├── HC_2026-07-24.zip
├── Onyx_2026-07-24.zip
├── PDV_2026-07-24.zip
