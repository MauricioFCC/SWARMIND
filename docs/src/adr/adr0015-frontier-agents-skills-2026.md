# ADR-0015: Frontier Agents & Skills 2026 — MetaClaw, AdaptOrch, MuTON, SWE-Master, ShapleyFlow, frontend-uiux

## Estado
**ACEPTADO** — Implementado en commit 306e9c4.

## Contexto
AGENTIC implementa agentes especializados (builder, scientist, guardian, coordinator, evolve) con skills registrados. Hasta ahora las técnicas incorporadas cubrían patrones de flujo (WFP), testing (PBT), contexto (CEN), trazabilidad (BTR), guardrails (AGR) y versionado (SVE) — ADR-0013 — y lazy loading — ADR-0014.
...
- ADR-0013: 6 nuevas técnicas (WFP, PBT, CEN, BTR, AGR, SVE)
- ADR-0014: Lazy Loading PEP 562
