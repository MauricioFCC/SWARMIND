# ADR-0014: Lazy Loading PEP 562 — Cold Start 72x mas rapido
...
Los 6 modulos creados en ADR-0013 tambien estan en el mapa lazy:
...
- ADR-0013: 6 nuevas tecnicas (lazy loading de esos modulos)
