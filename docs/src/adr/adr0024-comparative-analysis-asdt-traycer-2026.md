# ADR-0024: Comparative Analysis — ASDT + Traycer + AGENTIC

## Estado
**ACEPTADO** — Investigacion completada. Propuestas de mejora priorizadas.

## Contexto
Se analizaron dos proyectos frontier de sistemas multi-agente para identificar mejoras aplicables a AGENTIC:
...
2. **Traycer** (traycerai/traycer, 797 stars, 468 commits): Nerve Center for Agentic Coding — orquestación multi-agente con BYOA, Epic mode, unified context

## Analisis Comparativo

| Caracteristica | ASDT | Traycer | AGENTIC | Gap |
|---|---|---|---|---|
| **Runtime** | Claude Code / OpenCode | Claude Code / OpenCode / Cursor / Codex | Harness propio (Python) | AGENTIC no se integra con IDEs |
...
| **BYOA** | Solo Claude/OpenCode | Si (multi-provider) | Solo AGENTIC | Podria soportar otros LLMs |
...
## Propuestas de Mejora para AGENTIC

### 1. Memoria Cross-Session tipo Engram
**Inspiracion:** ASDT usa Engram como capa de memoria persistente entre sesiones.
**Propuesta:** 
- AGENTIC tiene ScopedContext y LanceDB pero la memoria no persiste entre sesiones de forma nativa
...
**Propuesta:**
- AGENTIC tiene Worktable para debate, pero no un modo "epico" para tareas largas
...
**Propuesta:**
- AGENTIC funciona como CLI standalone (run.py)
- Crear adaptador MCP para que AGENTIC pueda ser invocado desde Claude Code y OpenCode
...
**Propuesta:**
- AGENTIC tiene agentes fijos (coordinator, builder, scientist, guardian, evolve)
...
**Propuesta:**
- AGENTIC tiene `auto_route()` en DelegationEngine pero es implicito
...
## Consecuencias
- AGENTIC se mantiene como sistema independiente pero gana interoperabilidad
