...
| 0005 | Memoria Portable | Sistema de paths con 3 niveles de fallback: HERMES_ROOT env var → ~/shared_memory/ → ~/Swarmind_MEMORY/. Elimina paths absolutos. |
...
| ADRs | 30 activos (numeracion secuencial 0001-0030) |
| Tests | 3420 pasando |
...
- [Guía de Uso](../README.md) — Guía completa de uso
