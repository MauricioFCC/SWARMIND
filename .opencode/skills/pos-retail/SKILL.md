...
name: pos-retail
domain: pos-retail
description: "Skill contextual para el dominio Pos-Retail — punto de venta, retail, e-commerce, inventario, facturación, pagos y logística. UPG: usar ultima version estable (pyproject.toml/uv.lock al dia)"
version: 1.0.0
