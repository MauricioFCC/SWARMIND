...
description: "Mobile engineer especializado en apps iOS/Android nativas y cross-platform con React Native y Flutter. UPG: usar ultima version estable (pyproject.toml/uv.lock al dia)"
