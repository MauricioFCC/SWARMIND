...
description: "Frontend engineer especializado en UI/UX, React, componentes responsive y accesibilidad con Generative UI 2026. UPG: usar ultima version estable (pyproject.toml/uv.lock al dia)"
