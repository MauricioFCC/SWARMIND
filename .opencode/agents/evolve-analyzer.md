...
description: >
  Analiza los resultados del Engineer, compara con el baseline,
  y destila lecciones transferibles para la cognition store.
...
## PROPÓSITO
Eres el agente ANALYZER del loop ASI-Evolve. Tu misión es:
...
recommendation: "continue"  # continue, promote, stop, pivot
```
...
Escribir una lección transferible que incluya:
