...
Curated [shields.io](https://shields.io) badges ready to drop into the README.
All URLs are static and use the project's brand palette: `#06B6D4` (cyan) and `#0F172A` (navy).

> Tip: paste them inside a `<p>` tag or stack them like:
> ```md
...
## Compact row (for the README header)
...
| Token | Hex | Usage |
| --- | --- | --- |
| Cyan | `#06B6D4` | Primary action, links |
| Cyan light | `#22D3EE` | Highlights, hover |
| Navy | `#0F172A` | Background, dark text |
| Gold | `#F59E0B` | Accent, warnings, lock |
| Light | `#F1F5F9` | Foreground on dark |
| Dark | `#1E293B` | Subtle foreground |
